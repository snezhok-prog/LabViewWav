...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="CTLs" Type="Folder">
			<Item Name="AppStates.ctl" Type="VI" URL="../FGVs/AppStates.ctl"/>
			<Item Name="ButtonRefs.ctl" Type="VI" URL="../CTLs/ButtonRefs.ctl"/>
			<Item Name="data_exchange_fgv.ctl" Type="VI" URL="../FGVs/data_exchange_fgv.ctl"/>
			<Item Name="FGVstates.ctl" Type="VI" URL="../FGVs/FGVstates.ctl"/>
			<Item Name="GUI_states.ctl" Type="VI" URL="../CTLs/GUI_states.ctl"/>
			<Item Name="playback status.ctl" Type="VI" URL="../CTLs/playback status.ctl"/>
			<Item Name="settings.ctl" Type="VI" URL="../FGVs/settings.ctl"/>
		</Item>
		<Item Name="FGVs" Type="Folder">
			<Item Name="FGV_config.vi" Type="VI" URL="../FGVs/FGV_config.vi"/>
			<Item Name="FGV_data_exchange.vi" Type="VI" URL="../FGVs/FGV_data_exchange.vi"/>
			<Item Name="FGV_GUI_reference.vi" Type="VI" URL="../FGVs/FGV_GUI_reference.vi"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Item Name="acquire_error.vi" Type="VI" URL="../SubVIs/acquire_error.vi"/>
			<Item Name="audio_processor.vi" Type="VI" URL="../SubVIs/audio_processor.vi"/>
			<Item Name="check_current_status.vi" Type="VI" URL="../SubVIs/check_current_status.vi"/>
			<Item Name="command_processor.vi" Type="VI" URL="../SubVIs/command_processor.vi"/>
			<Item Name="error_processor.vi" Type="VI" URL="../SubVIs/error_processor.vi"/>
			<Item Name="GUI.vi" Type="VI" URL="../SubVIs/GUI.vi"/>
			<Item Name="init_main.vi" Type="VI" URL="../SubVIs/init_main.vi"/>
			<Item Name="visualyze_audio_data.vi" Type="VI" URL="../SubVIs/visualyze_audio_data.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Volume.vi" Type="VI" URL="../volume/Volume.vi"/>
			<Item Name="VolumeMaster.vi" Type="VI" URL="../volume/VolumeMaster.vi"/>
		</Item>
